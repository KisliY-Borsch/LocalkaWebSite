...
<h3 class="mt-1 mb-3">Опции</h3>

<div class="form-check">
  <input class="form-check-input" type="checkbox" value="" id="defaultCheck1">
  <label class="form-check-label" for="defaultCheck1">
Отправлять ли в ГЕРЦ информацию?
  </label>
</div>
<div class="form-check">
  <input class="form-check-input" type="checkbox" value="" id="defaultCheck2">
  <label class="form-check-label" for="defaultCheck2">
Переводить 1-го числа на помесячную оплату?
  </label>
</div>
<div class="form-check">
  <input class="form-check-input" type="checkbox" value="" id="defaultCheck3">
  <label class="form-check-label" for="defaultCheck3">
Уменьшать кредитный лимит при оплате?
  </label>
</div>
<div class="form-check">
...
<a class="btn btn-success btn-menu-lc btn-block mt-2" href="#">Сохранить</a>

<hr>
<h3 class="mt-1 mb-3">Перевод средств в пользу другого абонента</h3>

<form class="form-inline text-center">
  <div class="form-group mx-sm-3 mb-2">
    <label for="inputPassword2" class="sr-only">Укажите id абонента </label>
    <input type="text" class="form-control" id="IdAbonenta" placeholder="id абонента">
  </div>
  <div class="form-group mx-sm-3 mb-2">
    <label for="inputPassword2" class="sr-only">Переводимая сумма</label>
    <input type="text" class="form-control" id="Summa" placeholder="Переводимая сумма">
  </div>  
  <a class="btn btn-success btn-menu-lc btn-block mt-2" href="#">Сделать трафсфер</a>
</form>
